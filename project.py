...
def pr2_mover(detected_object_list):
    ...
    print "Sending commands to rotate PR2"
    left_angle = Float64()
...
if __name__ == '__main__':
    ...
    world_joint_pub = rospy.Publisher("/pr2/world_joint_controller/command", Float64, queue_size=3) # To rotate PR2 for collision analysis
    map_3d_pub = rospy.Publisher("/pr2/3d_map/points", PointCloud2, queue_size=1)                   # To publish surrounding collisions for motion planning
